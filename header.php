 ...
 *
 * @file           header.php
 * @package        Vanilla WP Theme
 * @author         Canonical Web Team
 * @copyright      2016 Canonical Ltd
 * @license
 * @version        Release: 1.0
 * @filesource     wp-content/themes/vanilla-wp-theme/header.php
...
<head>
		...
		<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/static/css/style.min.css" media="screen" title="no title" charset="utf-8">
